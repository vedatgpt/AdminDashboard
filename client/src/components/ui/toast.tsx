...
// Simple Toast Provider - just returns children
const ToastProvider = ({ children, ...props }: React.PropsWithChildren) => (
...
>(({ className, ...props }, ref) => (
  <button
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-gray-500 opacity-70 transition-opacity hover:text-gray-900 hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2",
      className
    )}
    {...props}
  >
