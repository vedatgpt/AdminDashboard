  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Bireysel kullanıcılar için ilan paketlerini oluşturun ve yönetin"
      />
      ...
      {filteredPackages.length === 0 && !searchTerm ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Henüz bireysel paket yok</h3>
          <p className="text-gray-500 mb-6">İlk bireysel paketinizi oluşturmaya başlayın.</p>
          <button
            onClick={() => setIsFormOpen(true)}
