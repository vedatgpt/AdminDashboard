          ...
          <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="peer py-3 px-4 pr-12 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500"
              ...
              <button
                ...
                className="absolute inset-y-0 end-0 flex items-center pointer-events-auto z-10 p-3.5"
              >
                {showPassword ? (
